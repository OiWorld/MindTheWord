...
$__System.register('a', ['3', '4'], function (_export) {
  var _createClass, _classCallCheck, ContentScriptCtrl;
      ...
      ContentScriptCtrl = (function () {
        ...
        _createClass(ContentScriptCtrl, [{
          ...
          value: function translate() {
            ...
            chrome.runtime.sendMessage({ getOptions: '1' }, function (res) {
              ...
              if (res.activation === true) {
                ...
                var filteredWords = _this.console.log(countedWords);
              } else {
...
$__System.register('1', ['2', '5', '6', 'a', 'c'], function (_export) {
  'use strict';
  ...
  return {
    setters: [function (_) {
      ...
      ContentScriptCtrl = _a.ContentScriptCtrl;
    }, function (_c) {
      angular = _c['default'];
    }],
    execute: function () {
