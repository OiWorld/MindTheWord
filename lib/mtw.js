...
$__System.registerDynamic("f", ["c", "10", "e"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
$__System.registerDynamic("12", ["f", "10", "11"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
$__System.registerDynamic("14", ["13", "10"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
$__System.register('16', ['3', '4', '15'], function (_export) {
  var _createClass, _classCallCheck, _Object$keys, ContentScriptCtrl;
      ...
      */
      ...
      ContentScriptCtrl = (function () {
          ...
          chrome.runtime.sendMessage({
            ...
            if (!!r.activation && !blacklist.test(document.URL)) {
              ...
              chrome.runtime.sendMessage({
                ...
                self.main(parseInt(r.ngramMin), parseInt(r.ngramMax), r.translationProbability, r.minimumSourceWordLength, JSON.parse(r.userDefinedTranslations), r.userBlacklistedWords, r.limitToUserDefined);
              });
            }
          });
        }
        ...
        _createClass(ContentScriptCtrl, [{
          key: 'main',
          value: function main(ngramMin, ngramMax, translationProbability, minimumSourceWordLength, userDefinedTranslations, userBlacklistedWords, limitToUserDefined) {
          ...
          key: 'getAllWords',
          value: function getAllWords(ngramMin, ngramMax, self) {
            var countedWords = {};
          ...
          key: 'filterSourceWordsLimitToUserDefined',
          value: function filterSourceWordsLimitToUserDefined(countedWords, translationProbability, userDefinedTranslations) {
          ...
          key: 'filterSourceWords',
          value: function filterSourceWords(countedWords, translationProbability, minimumSourceWordLength, userBlacklistedWords) {
          ...
          key: 'injectScript',
          value: function injectScript(scriptURL) {
          ...
          value: function invertMap(map) {
            ...
            for (var e in map) {
              iMap[map[e]] = '<span data-sl="' + srcLang + '" data-tl="' + targetLang + '" data-query="' + e + '" data-original="' + e + '" data-translated="' + map[e] + '" class="mtwTranslatedWord" onClick="' + swapJs + '">' + map[e] + '</span>';
            }
            return iMap;
          }
        }, {
          ...
          key: 'ngramAt',
          value: function ngramAt(list, index, n) {
            return list.slice(index, index + n).join(' ');
          }
        }, {
          key: '__mindtheword',
          value: function __mindtheword() {
...
$__System.register('1', ['2', '5', '6', '16', '18'], function (_export) {
  'use strict';

  var BingTranslate, GoogleTranslate, YandexTranslate, ContentScriptCtrl, angular, blacklist, srcLang, targetLang;
