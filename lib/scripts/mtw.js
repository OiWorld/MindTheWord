...
<<<<<<< HEAD
    ...
    initialize(res) {
        ...
        var custom_icon = chrome.extension.getURL("assets/img/volume.png");
...
<<<<<<< HEAD
        ...
        for (let i = 0; i < paragraphs.length; i++) {
            ...
            for (let i = 0; i < translatedWords.length; i++) {
                var hoverHTML = '<p>' + translatedWords[i].getAttribute("data-original") + '</p><img class="mtwSpeak" data-translated="' + translatedWords[i].getAttribute("data-translated") + '" src="' + this.custom_icon + '"';
...
=======
        ...
        for (let i = 0; i < translatedWords.length; i++) {
            //var hoverHTML = '<p>' + translatedWords[i].getAttribute("data-original") + '</p>' + '<button class="kylie" ><span class="glyphicon glyphicon-trash"></span></button>';
            console.log(this.custom_icon);
            var hoverHTML = '<p>' + translatedWords[i].getAttribute("data-original") + '</p><img class="mtwSpeak" data-translated="' + translatedWords[i].getAttribute("data-translated") + '" src="' + this.custom_icon + '"';
            $(translatedWords[i]).hovercard({
                detailsHTML: hoverHTML,
                width: 250
            });
            console.log(translatedWords[i]);
        }
    }
            ...
            if (paragraph.childNodes[i].nodeType === 3) {
                if (!/^\s*$/.test(paragraph.childNodes[i].textContent)) {
                    if (this.srcLang == yandexLanguages.Hindi) {
                        ...
                        newNode.innerHTML = sentences.join(':');
                        paragraph.replaceChild(newNode, paragraph.childNodes[i]);
                    } else if ((this.srcLang == yandexLanguages.Chinese) || (this.srcLang == bingLanguages["Chinese Simplified"]) || (this.srcLang == bingLanguages["Chinese Traditional"])) {
                        let sentences = paragraph.childNodes[i].textContent.split('。');
                        for (let j in sentences) {
                            let words = sentences[j].split("");
                            words = _.shuffle(words);
...
<<<<<<< HEAD
                    if ((this.srcLang == yandexLanguages.Chinese) || (this.srcLang == bingLanguages["Chinese Simplified"]) || (this.srcLang == bingLanguages["Chinese Traditional"]) || (this.srcLang == yandexLanguages.Japanese)) {
=======
                    if ((this.srcLang == yandexLanguages.Chinese) || (this.srcLang == bingLanguages["Chinese Simplified"]) || (this.srcLang == bingLanguages["Chinese Traditional"])) {
                        4
>>>>>>> hover
