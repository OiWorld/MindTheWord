        ...
        return this.each(function() {
            function g(c, d, e, g) {
                ...
                switch (c) {
                    case "twitter":
                        {
                            i = "http://api.twitter.com/1/users/lookup.json?screen_name=" + d;h = function(a) {
                                a = a[0];
                            ...
                            };k = "Contacting Twitter...";l = "Invalid username or you have exceeded Twitter request limit.<br/><small>Please note, Twitter only allows 150 requests per hour.</small>";j = function() {};
                    ...
                    case "facebook":
                        {
                            ...
                            };k = "Contacting Facebook...";l = "The requested user, page, or event could not be found. Please try a different one.";j = function(b) {
                    ...
                    case "custom":
                        {
                            ...
                            };k = "Loading...";l = "Sorry, no data found.";j = function() {}
                        }
                        break;
                    default:
                        {}
            ...
            c.closest(".hc-preview").hover(function() {
                ...
                f(d);
                d.css("zIndex", "20000");
                c.css("zIndex", "10000").find(".hc-details").css("zIndex", "5000");
